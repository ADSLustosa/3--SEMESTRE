...
/* Classe __Aula3_ED: encarregada de executar algumas funcionalidades com objetos do tipo Candidato a um concurso musical armazenados em um vetor.
	...
	Autor Aluno: <João Pedro Lima Lustosa Amorim- RA: 10289920>
...
public class __Aula3_ED {
    ...
    public void criarCadastroCandidatos(Candidato[] candidatos) {	
		...
		candidatos[10] = new Candidato(1313, "121.212.121-21", "Mateus", 28, 'M', "rock");
		candidatos[11] = new Candidato(1414, "131.313.131-31", "Yara", 18, 'F', "rap");
		candidatos[12] = new Candidato(1515, "141.414.141-41", "Jessica", 26, 'F', "forró");
		candidatos[13] = new Candidato(1616, "151.515.151-51", "Mariana", 29, 'F', "romantica");
		candidatos[14] = new Candidato(1717, "161.161.161-61", "João Pedro.", 24, 'M', "rap");
